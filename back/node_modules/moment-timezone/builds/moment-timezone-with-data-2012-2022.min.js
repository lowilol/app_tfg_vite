! function(a, i) {
    ...
    function t(a) {
        var i = 0,
            ...
            A = 0,
            e = 1;
        for (45 === a.charCodeAt(0) && (e = -(i = 1)); i < r.length; i++) A = 60 * A + n(r.charCodeAt(i));
    ...
    function p(a) {
        for (var a = a.split("|"), i = a[2].split(" "), e = a[3].split(""), r = a[4].split(" "), o = (l(i), l(e), l(r), r), c = e.length, A = 0; A < c; A++) o[A] = Math.round((o[A - 1] || 0) + 6e4 * o[A]);
        return o[c - 1] = 1 / 0, {
            name: a[0],
            abbrs: f(a[1].split(" "), e),
            offsets: f(i, e),
    ...
    function E() {
        for (var a, i, e, r = (new Date).getFullYear() - 2, o = new d(new Date(r, 0, 1)), c = o.offset, A = [o], n = 1; n < 48; n++)(e = new Date(r, n, 1).getTimezoneOffset()) !== c && (a = function(a, i) {
            for (var e; e = 6e4 * ((i.at - a.at) / 12e4 | 0);)(e = new d(new Date(a.at + e))).offset === a.offset ? a = e : i = e;
            return a
        }(o, i = new d(new Date(r, n, 1))), A.push(a), A.push(new d(new Date(a.at + 6e4))), o = i, c = e);
        for (n = 0; n < 4; n++) A.push(new d(new Date(r + n, 0, 1))), A.push(new d(new Date(r + n, 6, 1)));
        return A
    }
        ...
        for (var e, r, o = E(), c = o.length, A = function(a) {
                for (var i, e, r, o = a.length, c = {}, A = [], n = {}, t = 0; t < o; t++)
                    if (e = a[t].offset, !n.hasOwnProperty(e)) {
                        for (i in r = m[e] || {}) r.hasOwnProperty(i) && (c[i] = !0);
                        n[e] = !0
    ...
    function T(a) {
        ...
        for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
            ...
            var c, A, n = o,
                t = r[2].split(" ");
            for (l(t), c = 0; c < t.length; c++) A = t[c], m[A] = m[A] || {}, m[A][n] = !0
        }
    }
    ...
    function _(a) {
        var i, e, r, o;
        for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) r = P((e = a[i].split("|"))[0]), o = P(e[1]), c[r] = o, u[r] = e[0], c[o] = r, u[o] = e[1]
    }

    function k(a) {
        T(a.zones), _(a.links);
        var i, e, r, o = a.countries;
        if (o && o.length)
            for (i = 0; i < o.length; i++) e = (r = o[i].split("|"))[0].toUpperCase(), r = r[1].split(" "), A[e] = new M(e, r);
    ...
    function O(a) {
        ...
        _index: function(a) {
            a = function(a, i) {
                ...
                if (a >= i[r - 1]) return -1;
                for (var o = 0, c = r - 1; 1 < c - o;) i[e = Math.floor((o + c) / 2)] <= a ? o = e : c = e;
                return c
            }(+a, this.untils);
            if (0 <= a) return a
        },
        ...
        var a, i = [];
        for (a in u) u.hasOwnProperty(a) && (s[a] || s[c[a]]) && u[a] && i.push(u[a]);
        return i.sort()
