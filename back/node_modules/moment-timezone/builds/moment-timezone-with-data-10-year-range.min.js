! function(a, i) {
    ...
    function t(a) {
        var i = 0,
            ...
            A = 0,
            r = 1;
        for (45 === a.charCodeAt(0) && (r = -(i = 1)); i < e.length; i++) A = 60 * A + n(e.charCodeAt(i));
    ...
    function p(a) {
        for (var a = a.split("|"), i = a[2].split(" "), r = a[3].split(""), e = a[4].split(" "), o = (l(i), l(r), l(e), e), c = r.length, A = 0; A < c; A++) o[A] = Math.round((o[A - 1] || 0) + 6e4 * o[A]);
        return o[c - 1] = 1 / 0, {
            name: a[0],
            abbrs: f(a[1].split(" "), r),
            offsets: f(i, r),
    ...
    function E() {
        for (var a, i, r, e = (new Date).getFullYear() - 2, o = new h(new Date(e, 0, 1)), c = o.offset, A = [o], n = 1; n < 48; n++)(r = new Date(e, n, 1).getTimezoneOffset()) !== c && (a = function(a, i) {
            for (var r; r = 6e4 * ((i.at - a.at) / 12e4 | 0);)(r = new h(new Date(a.at + r))).offset === a.offset ? a = r : i = r;
            return a
        }(o, i = new h(new Date(e, n, 1))), A.push(a), A.push(new h(new Date(a.at + 6e4))), o = i, c = r);
        for (n = 0; n < 4; n++) A.push(new h(new Date(e + n, 0, 1))), A.push(new h(new Date(e + n, 6, 1)));
        return A
    }
    ...
    function P() {
        ...
        for (var r, e, o = E(), c = o.length, A = function(a) {
            ...
            for (r = new d(z(A[t])), e = 0; e < c; e++) r.scoreOffsetAt(o[e]);
            n.push(r)
        }
    ...
    function k(a) {
        var i, r, e, o;
        for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) e = S((r = a[i].split("|"))[0]), o = S(r[1]), c[e] = o, u[e] = r[0], c[o] = e, u[o] = r[1]
    }
    ...
    function _(a) {
        ...
        if (o && o.length)
            for (i = 0; i < o.length; i++) r = (e = o[i].split("|"))[0].toUpperCase(), e = e[1].split(" "), A[r] = new b(r, e);
    ...
    function L(a) {
        ...
        _index: function(a) {
            a = function(a, i) {
                ...
                if (a >= i[e - 1]) return -1;
                for (var o = 0, c = e - 1; 1 < c - o;) i[r = Math.floor((o + c) / 2)] <= a ? o = r : c = r;
                return c
            }(+a, this.untils);
            if (0 <= a) return a
        },
